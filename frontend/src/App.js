...
import Department from "./Pages/AdminDashboard/master/Department/Department";
import CountryServices from "./Pages/AdminDashboard/master/CountryService/CountryServices";
...
import Dummytwo from './dummy2.js'
      ...
      <Router>
        <Routes>
          <Route path="/" element={<Layout />}>
            ...
            />
            <Route
              path="/services/CourierPickup/"
              element={<CourierPickup />}
            />

            <Route
              path="/countries/:countryName/:serviceName"
              element={<CountriesServiceDetails />}
            />
            <Route
          ...
          <Route path="dashboard" element={<CustomerPrivateRoute />}>
            <Route path="/dashboard" element={<Dashboard />}>
              ...
              <Route
                path="ticket/dummy/:dummytickets"
          ...
          <Route path="Admindashboard" element={<AdminPrivateRoute />}>
            <Route path="/Admindashboard" element={<AdminDashboard />}>
              ...
              <Route path="VisaApplicationDoc" element={<VisaApplicationDoc/>}/>
