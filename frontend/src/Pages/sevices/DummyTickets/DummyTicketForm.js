...
//                 <input className="form-check-input " type="radio" name="tripType" value="oneWay" checked={tripType === 'oneWay'} onChange={handleChange} />
//                 One Way
//               </label>
//               <label className="form-check-label">
//                 <input className="form-check-input" type="radio" name="tripType" value="roundTrip" checked={tripType === 'roundTrip'} onChange={handleChange} />
//                 Round Trip
//               </label>
//             </div>
//           </div>
...
//               <input type="text" className="dummy-form-control form-control" name="from" placeholder="Country Name" value={from} onChange={handleChange} required/>
//             </div>
//             <div className='fromto'>
//               <label className="form-label">Departure City:</label>
//               <input type="text" className="dummy-form-control form-control" name="to" placeholder="Country Name" value={to} onChange={handleChange} required/>
//             </div>
//           </div>
//         </div>
//         <div className="form-group">
...
//               <input type="date" className="dummy-form-control form-control" value={departureDate} name="departureDate" onChange={handleChange} required/>
//             </div>
//             {tripType === 'roundTrip' && (
//               <>
//                 <div className='Return_date'>
//                   <label className="label_return">Return Date:</label>
//                   <input type="date" className="dummy-form-control form-control" value={returnDate} name="returnDate" onChange={handleChange} required/>
//                 </div>
//               </>
//             )}
//           </div>
...
//                 <tr key={index}>
//                   <td><input type="text" className="dummy-form-control form-control" value={passenger.name} onChange={(e) => handlePassengerChange(index, 'name', e.target.value)} required/></td>
//                   <td><input type="text" className="dummy-form-control form-control" value={passenger.age} onChange={(e) => handlePassengerChange(index, 'age', e.target.value)} required/></td>
//                   <td><input type="text" className="dummy-form-control form-control" value={passenger.passportNumber} onChange={(e) => handlePassengerChange(index, 'passportNumber', e.target.value)} required/></td>
