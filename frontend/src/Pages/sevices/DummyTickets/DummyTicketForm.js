...
function DummyTicketForm() {
  ...
  const { tripType, returnDate, departureDate, passengerDetails, from, to } =
    formData;
  ...
  const handleAddPassenger = () => {
    setFormData({
      ...
      passengerDetails: [
        ...passengerDetails,
        { name: "", age: "", passportNumber: "" },
      ],
    });
  };

  const handleRemovePassenger = (index) => {
    const updatedPassengerDetails = passengerDetails.filter(
      (_, i) => i !== index
    );
    setFormData({
      ...formData,
        ...
        <div className="form-group">
          <div className="date-group">
            <div className="Departure_date">
              <label className="label_Departure form-label">
                Departure Date:
              </label>
              <input
                type="date"
