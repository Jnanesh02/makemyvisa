...
//                     <div className="visaApplication-form-group">
//                     <label htmlFor="Destinationcountry" className="visaApplication-label">
//                       Destination Country
//                     </label>
//                     <select
...
//                         {countriesData
//                           .find((country) => country.countryName === formData.destination)
...
<div className="visaApplication-form" >
  ...
  <div className="visaApplication-form-row">
    ...
    <div className="visaApplication-form-group">
      <label htmlFor="passport" className="visaApplication-label">
        Passport Number
      </label>
      <input
        type="number"
  ...
  <button type="submit" className="btn btn-danger-submit" style={{background:"#e12912",color:'white'}} onClick={() => setShowModal(true)} disabled={paymentConfirmed}>
    Submit
  </button>
</div>
</div>
...
{/* 
  ...
  {showSuccessMessage && (
  <div className="d-flex justify-content-center"><SuccessDiv>
     <SuccessIcon />
         <Typography variant="body1">Application Submitted</Typography>
       </SuccessDiv></div>
  ...
  {paymentSubmitted && !paymentConfirmed && (
    <div>
     ...
     <Typography variant="h6" gutterBottom>
      ...
      <button className="btn btn-success" onClick={handleSubmit} disabled={paymentConfirmed}>
        Payment
      </button>
    </div>
  )}
